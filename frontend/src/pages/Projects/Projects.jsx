  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="projects, resume, web developer, portfolio, React, Node.js, C#, front-end, back-end, JavaScript, HTML, CSS, PostgreSQL"
        />
        <meta
          property="og:title"
          content="Projekty - Portfolio Web Developera"
        />
        <meta
          property="og:description"
          content="Zapoznaj się z moimi projektami programistycznymi, w tym aplikacjami webowymi i desktopowymi."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="http://mikolajmelnyk.com.pl/Projects"
        />
      ...
      <div className="projects-container">
        ...
        <div className="social-icon-git">
          <ul>
            <li>
              <a
                href="https://github.com/Mikolaj1921"
                target="_blank"
              ...
              <div className="pt-img">
                <div className="social-icon-git-pt-img">
                  <ul>
                    <li>
                      <a
                        href="https://github.com/Mikolaj1921/SlodkaChwila"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <i className="fa-brands fa-github"></i>
              ...
              <div className="pt-img">
                <div className="social-icon-git-pt-img">
                  <ul>
                    <li>
                      <a
                        href="https://github.com/Mikolaj1921/ManagementConsulting"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <i className="fa-brands fa-github"></i>
              ...
              <div className="pt-img">
                <div className="social-icon-git-pt-img">
                  <ul>
                    <li>
                      <a
                        href="https://github.com/Mikolaj1921/DentalClinic"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <i className="fa-brands fa-github"></i>
              ...
              <div className="pt-img">
                <div className="social-icon-git-pt-img">
                  <ul>
                    <li>
                      <a
                        href="https://github.com/Mikolaj1921/Portfolio"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <i className="fa-brands fa-github"></i>
